...
---
## ✨ Features
* **Semantic Search:** Utilizes the Google Vertex AI API (`models/gemini-embedding-001`) to understand the deep context of user queries and match them against book descriptions.
...
* **Machine Learning & NLP:** LangChain, Google Vertex AI (Gemini Embeddings)
...
### Prerequisites
1. You must have a **Vertex AI API Key** to use Gemini embeddings.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/EKtechie/gen-ai.git
   cd book-recommender
   ```
